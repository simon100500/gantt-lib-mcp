 мне надо получить функцию РЕСУРСОВ. Чтобы можно было назначать ресурсы на задачи.
│
│ И отдельно обязательно планировщик ресурсов - отдельный экран для этого ПУЛА проекта и отдельного проекта. То есть мы можем
│ объединять проекты в пулы, чтобы видеть сквозное назначение ресурсов и коллизии. пулы будут отображаться в сайдбаре - как группы
│ со свои названием.
│
│ на странице ресурсов будет интерфейс управления. по левой части столбец ресурсов, а в правой части столбец задач в календарной
│ сетке. То есть я назначаю ресурс с графика гантта. а смотрю пересечение и прочее - уже на отдельном экране. тут же можно
│ добавлять новый ресурс. тут же можно двигать задачу. то есть тот же график ганта но упрощённый чисто с дочерними задачами, на
│ которые назначены ресурсы. тут главное видеть какой ресурс у нас где занят. пока что у нас нет в библиотеке ганта gant-lib
│ возможности размещать несколько полос в одной строке. поэтому нужно сделать просто кастомный компонент, возможно на основе
│ продходов gantt-lib но локально внутри проекта. наша задача чтобы можно было видеть наложения ресурсов если я назначу их с разных
│ графиков. то есть мы назначаем с ганта а разруливаем с режима Ресурсы. Типы ресурсов будут: Люди, Машины, Инструмент, Материал,
│ Прочее.
