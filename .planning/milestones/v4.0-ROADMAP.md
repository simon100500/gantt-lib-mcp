...
- [x] **Phase 25: Interactive Preview** - Astro islands with drag-to-edit gantt chart
...
- [x] 25-01-PLAN.md — Install gantt-lib dependency and create basic interactive GanttPreview component
- [x] 25-02-PLAN.md — Add hierarchical tasks, collapse/expand, CSS theme overrides, and polish
