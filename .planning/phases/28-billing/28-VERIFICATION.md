...
| 7 | Enterprise plan shows "contact us" instead of payment flow | VERIFIED | `pricing.astro` line 76-77: enterprise ctaLabel = "Напишите нам", ctaHref = mailto link. `BillingPage.tsx` line 304-310: enterprise card renders `<a href="mailto:ai@getgantt.ru">Напишите нам</a>` instead of payment button |
