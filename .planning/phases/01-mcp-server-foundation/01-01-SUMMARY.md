...
tags: [typescript, modelcontextprotocol, stdio, mcp-sdk]
...
affects: [02-task-model, 03-tool-implementation, 04-integration-testing]

# Tech tracking
tech-stack:
  added: ["@modelcontextprotocol/sdk@^1.0.4", "typescript@^5.7.2", "typescript-esm@^2.0.0"]
  patterns: ["stdio transport for MCP", "ES modules (type: module)", "tool registration with request handlers"]
