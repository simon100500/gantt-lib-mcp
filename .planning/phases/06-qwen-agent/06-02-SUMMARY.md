...
plan: "02"
subsystem: agent
tags: [qwen-code-sdk, typescript, mcp, cli, z.ai, glm-4.7]
...
affects: [tasks.json runtime output]

# Tech tracking
tech-stack:
  added: ["@qwen-code/sdk v0.1.5"]
  patterns:
    - "query({ prompt, options }) API — options object wraps all config"
    - "message.message.content for SDKAssistantMessage (wrapped in .message)"
    - "authType: openai for Z.AI OpenAI-compatible endpoint"
    - "resolveEnv() with ANTHROPIC_* fallback chain for OPENAI_* vars"
