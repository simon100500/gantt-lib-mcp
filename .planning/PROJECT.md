...
- [ ] Phase 9 Plan 6: Auth UI (OTP modal, project switcher)
...
- **Хранение:** SQLite с @libsql/client (WASM, без компиляции)
- **Язык:** TypeScript для соответствия gantt-lib экосистеме
- **Деплой:** Единый Docker контейнер на CapRover
...
| SQLite вместо PostgreSQL | Проще деплой, нет внешних зависимостей | ✓ Good |
