...
ARG VITE_LANDING_SITE_URL=https://getgantt.ru/
ENV VITE_YANDEX_CLIENT_ID=${VITE_YANDEX_CLIENT_ID}
ENV VITE_LANDING_SITE_URL=${VITE_LANDING_SITE_URL}
...
ARG VITE_YANDEX_CLIENT_ID
ARG VITE_LANDING_SITE_URL=https://getgantt.ru/
ARG FACT_PUBLIC_APP_URL=https://fact.getgantt.ru
ARG ADMIN_EMAIL
ARG ADMIN_EMAILS
ARG PORT=3000
...
ENV VITE_YANDEX_CLIENT_ID=${VITE_YANDEX_CLIENT_ID}
ENV VITE_LANDING_SITE_URL=${VITE_LANDING_SITE_URL}
ENV FACT_PUBLIC_APP_URL=${FACT_PUBLIC_APP_URL}
