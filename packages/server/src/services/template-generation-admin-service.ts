  ...
  try {
    const response = await completeTextPrompt({
      ...
      prompt: [
        ...
        '',
        '## Почему удобно вести такой проект в GetGantt',
        'Объясни, почему для этого проекта важны зависимости между задачами, сроки и контрольные точки.',
        'Покажи 2-3 конкретных примера зависимостей, опираясь на реальный график. Не выдумывай примеры, которых нет в структуре работ.',
        'Объясни, что в GetGantt эта логика видна на диаграмме Ганта: что идет последовательно, что можно делать параллельно, где могут возникнуть задержки.',
        'Длина раздела: 3-5 коротких абзацев.',
        '',
