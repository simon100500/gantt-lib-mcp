  ...
  try {
    const response = await completeTextPrompt({
      ...
      prompt: [
        ...
        '1. Что это за шаблон?',
        '2. Для чего он нужен?',
        '3. Какой состав и логика работ уже заложены в шаблоне?',
        '4. Как его использовать?',
        '5. Что делать, если готовый шаблон не подошел?',
        '',
        'Структура seoBody:',
        '## Что это за шаблон',
        ...
        '',
        '## Как использовать шаблон',
        'Очень короткий полу-статичный блок.',
        'Без длинного вводного абзаца. Просто 3-5 коротких шагов в стиле: скопировать шаблон в свой проект, поправить сроки, убрать или добавить нужные работы, уточнить зависимости и сохранить свой вариант.',
        '',
        '## Если шаблон не подошел',
